...
const DEMO_PAIR = {
  imageUrls: [
    {
      before: '/images/text-image-1.png',
      after:  '/images/text-image-1.png',
      prompt: "A high-angle, top-down cinematic portrait of a young woman with wavy brown hair looking directly up at the camera with a soft, soulful expression. She is holding a bouquet of deep red roses wrapped in brown craft paper. She wears a simple black long-sleeved top and a yellow crossbody bag. The scene is set on a brick pathway during golden hour, with soft, hazy sunlight filtering through the background creating a dreamlike glow. The photography style features a shallow depth of field with a heavy film grain and a vintage, nostalgic color palette.",
    },
    {
      before: '/images/text-image-2.png',
      after:  '/images/text-image-2.png',
      prompt: "A luxury high-fashion magazine cover in a soft light purple (lavender) gradient background. A beautiful young white female model with delicate facial features, glowing skin, and a confident, elegant expression stands centered. She is wearing a dramatic, high-volume couture gown made of layered tulle in pastel purple shades, creating a dreamy, cloud-like silhouette. The model is holding a bouquet of lush purple flowers (roses, peonies, lilacs) with soft bokeh effect. Her hair is styled in a loose, romantic updo with soft strands framing her face. Subtle glamorous makeup, glossy lips, and soft blush. Large bold magazine title 'BONANZA' in thick, elegant serif font placed behind the model's head, partially obscured. Clean editorial layout with realistic magazine typography. Add side cover text in refined fashion magazine style: 'The New Romance', 'Beauty in Bloom', 'Dress to Dream', '10 Ways to Elevate Your Style', 'Special Feature: The Art of Slow Fashion'. Include barcode, date (May issue), and tagline at bottom: 'Live Beautifully – Fashion that inspires, empowers & transforms.' Lighting: soft studio lighting, diffused glow, high-end Vogue-style editorial, ultra-realistic, cinematic, shallow depth of field, luxury aesthetic, 8K detail.",
    },
    {
      before: '/images/text-image-3.png',
      after:  '/images/text-image-3.png',
    ...
    {
      before: '/images/text-image-4.png',
      after:  '/images/text-image-4.png',
      prompt: "Create an ultra refined editorial 'My 2026' identity board in a high luxury clean girl magazine collage style inspired by Rhode, Glossier, Skims, Aesop, Byredo and Chanel beauty minimal aesthetic combined with a soft neutral luxury lifestyle moodboard. Main focus is a full body cut out portrait of a woman placed in the center, cleanly extracted with a soft realistic shadow underneath, standing in a confident elegant power pose with straight posture relaxed shoulders and a calm self assured gaze, strict identity preservation do not change facial features proportions or structure keep natural skin texture fully visible and realistic. Outfit is carefully selected to match her personal vibe and enhance natural beauty using perfectly tailored minimal premium pieces in soft clean tones such as ivory, milk white, soft beige, light taupe, warm cream and subtle blush, refined silhouette like a structured blazer with relaxed trousers, a soft ribbed dress or clean minimal set, fabrics look expensive and tactile such as cotton, silk, cashmere or fine knit with no visible logos and understated elevated styling. Accessories are minimal and intentional including delicate gold jewelry thin rings simple earrings a clean elegant watch glossy natural nails in milky nude or soft pink tones everything balanced light and effortless. Hair is polished but natural either a sleek low bun soft straight hair or effortless blowout with healthy shine and movement no heaviness. Makeup follows clean girl aesthetic with fresh skin focus very natural and not overloaded featuring dewy hydrated glowing skin minimal base soft contour subtle blush natural brows light mascara and glossy lips or lip balm finish creating a fresh healthy radiant look inspired by Rhode and Glossier beauty campaigns. Lighting is soft diffused natural light like morning sunlight through a window with creamy highlights soft shadows no harsh contrast maintaining depth realism and luminous skin. Color palette is cohesive and perfectly suited built around milk white ivory beige soft taupe warm neutrals blush tones and soft gold accents creating an airy calm and expensive look. Background and composition form a layered editorial collage using curated clean luxury lifestyle elements such as skincare bottles Rhode lip treatments minimal makeup products marble textures linen fabrics soft bedsheets glass reflections matcha or iced coffee in aesthetic cups minimal interiors sunlight shadows mirrors magazines self care details subtle jewelry and clean bathroom aesthetics all styled minimal and intentional. Layout is structured as a clean editorial grid with soft layering and depth no clutter balanced composition with breathing space and high end Pinterest editorial aesthetic. Typography uses refined minimal fonts combining elegant serif and clean modern sans serif inspired by high fashion editorials with subtle glossy or soft metallic accents in gold or pearl tones very minimal and elegant. Sections such as ABOUT ME",
    },
    {
      before: '/images/text-image-5.png',
      after:  '/images/text-image-5.png',
                    ...
                    <SimpleImage
                      ...
                      <>
                        <button
                          ...
                          style={{ padding: '0.5rem 0.875rem', background: 'rgba(0,0,0,0.55)', border: 'none', borderRadius: '8px', color: 'white', fontSize: '0.8125rem', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.375rem', backdropFilter: 'blur(8px)', transition: 'all 0.2s ease' }}>
                        ...
                        <a href="/my-images"
                          ...
                          style={{ padding: '0.5rem 0.875rem', background: 'rgba(0,0,0,0.55)', border: 'none', borderRadius: '8px', color: 'white', fontSize: '0.8125rem', fontWeight: 600, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '0.375rem', textDecoration: 'none', backdropFilter: 'blur(8px)', transition: 'all 0.2s ease' }}>
